defmodule PhiaDemoWeb.Demo.Kanban.Layout do
  @moduledoc "Kanban app shell layout."
  ...
  def layout(assigns) do
    ...
    <.shell>
      <:topbar>
        ...
        <.project_topbar current_project={:kanban} dark_mode_id="kanban-dm" />
      </:topbar>
      <:sidebar>
        <.sidebar>
          <:brand>
            <div class="flex items-center gap-2.5">
              ...
              <div>
                <span class="text-sm font-bold text-foreground leading-none">Kanban</span>
                <p class="text-[10px] text-muted-foreground leading-none mt-0.5 font-medium">Project Board</p>
              </div>
            </div>
          </:brand>
          <:nav_items>
            <.nav_section label="Board">
              <.nav_item current_path={@current_path} href="/kanban" icon="layout-grid" label="Board" />
            </.nav_section>
            <.nav_section label="Projects">
              <.nav_item current_path={@current_path} href="/kanban" icon="layers" label="PhiaUI v0.2" badge={12} />
            </.nav_section>
          </:nav_items>
          <:footer_items>
            <div class="px-3 py-1">
