defmodule PhiaDemoWeb.Demo.ApiKeys.Layout do
  @moduledoc "API Keys app shell layout."
  ...
  def layout(assigns) do
    ...
    <.shell>
      <:topbar>
        ...
        <.project_topbar current_project={:api_keys} dark_mode_id="apikeys-dm" />
      </:topbar>
      <:sidebar>
        <.sidebar>
          <:brand>
            <div class="flex items-center gap-2.5">
              ...
              <div>
                <span class="text-sm font-bold text-foreground leading-none">API Keys</span>
                <p class="text-[10px] text-muted-foreground leading-none mt-0.5 font-medium">Access Management</p>
              </div>
            </div>
          </:brand>
          <:nav_items>
            <.nav_section label="Management">
              <.nav_item current_path={@current_path} href="/api-keys" icon="shield" label="API Keys" />
              <.nav_item current_path={@current_path} href="/api-keys" icon="users" label="Team Access" />
              <.nav_item current_path={@current_path} href="/api-keys" icon="list" label="Audit Log" />
            </.nav_section>
            <.nav_section label="Settings">
              <.nav_item current_path={@current_path} href="/api-keys" icon="settings" label="Permissions" />
              <.nav_item current_path={@current_path} href="/api-keys" icon="bell" label="Alerts" />
            </.nav_section>
          </:nav_items>
          <:footer_items>
            <div class="px-3 py-1">
