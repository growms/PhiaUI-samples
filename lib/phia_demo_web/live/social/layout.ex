defmodule PhiaDemoWeb.Demo.Social.Layout do
  @moduledoc "Social media app shell layout."
  ...
  def layout(assigns) do
    ...
    <.shell>
      <:topbar>
        ...
        <.project_topbar current_project={:social} dark_mode_id="social-dm" />
      </:topbar>
      <:sidebar>
        <.sidebar>
          <:brand>
            <div class="flex items-center gap-2.5">
              ...
              <div>
                <span class="text-sm font-bold text-foreground leading-none">Social</span>
                <p class="text-[10px] text-muted-foreground leading-none mt-0.5 font-medium">Community Feed</p>
              </div>
            </div>
          </:brand>
          <:nav_items>
            <.nav_section label="Feed">
              <.nav_item current_path={@current_path} href="/social" icon="home" label="Home Feed" />
              <.nav_item current_path={@current_path} href="/social" icon="trending-up" label="Trending" />
              <.nav_item current_path={@current_path} href="/social" icon="bell" label="Notifications" badge={7} />
            </.nav_section>
            <.nav_section label="Profile">
              <.nav_item current_path={@current_path} href="/social" icon="user" label="My Profile" />
              <.nav_item current_path={@current_path} href="/social" icon="users" label="Following" />
              <.nav_item current_path={@current_path} href="/social" icon="star" label="Bookmarks" />
            </.nav_section>
          </:nav_items>
          <:footer_items>
            <div class="px-3 py-1">
