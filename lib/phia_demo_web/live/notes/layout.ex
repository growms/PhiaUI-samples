defmodule PhiaDemoWeb.Demo.Notes.Layout do
  @moduledoc "Notes app shell layout."
  ...
  def layout(assigns) do
    ...
    <.shell>
      <:topbar>
        ...
        <.project_topbar current_project={:notes} dark_mode_id="notes-dm" />
      </:topbar>
      <:sidebar>
        <.sidebar>
          <:brand>
            <div class="flex items-center gap-2.5">
              ...
              <div>
                <span class="text-sm font-bold text-foreground leading-none">Notes</span>
                <p class="text-[10px] text-muted-foreground leading-none mt-0.5 font-medium">Rich Text Notes</p>
              </div>
            </div>
          </:brand>
          <:nav_items>
            <.nav_section label="Notes">
              <.nav_item current_path={@current_path} href="/notes" icon="pencil" label="All Notes" />
            </.nav_section>
            <.nav_section label="Tags">
              <.nav_item current_path={@current_path} href="/notes" icon="tag" label="Work" />
              <.nav_item current_path={@current_path} href="/notes" icon="tag" label="Personal" />
              <.nav_item current_path={@current_path} href="/notes" icon="tag" label="Ideas" />
            </.nav_section>
          </:nav_items>
          <:footer_items>
            <div class="px-3 py-1">
