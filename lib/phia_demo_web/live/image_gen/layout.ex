defmodule PhiaDemoWeb.Demo.ImageGenerator.Layout do
  @moduledoc "Image Generator app shell layout."
  ...
  def layout(assigns) do
    ...
    <.shell>
      <:topbar>
        ...
        <.project_topbar current_project={:image_gen} dark_mode_id="imagegen-dm" />
      </:topbar>
      <:sidebar>
        <.sidebar>
          <:brand>
            <div class="flex items-center gap-2.5">
              ...
              <div>
                <span class="text-sm font-bold text-foreground leading-none">Image Gen</span>
                <p class="text-[10px] text-muted-foreground leading-none mt-0.5 font-medium">AI Image Studio</p>
              </div>
            </div>
          </:brand>
          <:nav_items>
            <.nav_section label="Studio">
              <.nav_item current_path={@current_path} href="/image-generator" icon="image" label="Generate" />
              <.nav_item current_path={@current_path} href="/image-generator" icon="layout-grid" label="Gallery" />
            </.nav_section>
            <.nav_section label="Styles">
              <.nav_item current_path={@current_path} href="/image-generator" icon="star" label="Photorealistic" />
              <.nav_item current_path={@current_path} href="/image-generator" icon="star" label="Illustration" />
              <.nav_item current_path={@current_path} href="/image-generator" icon="star" label="3D Render" />
            </.nav_section>
          </:nav_items>
          <:footer_items>
            <div class="px-3 py-1">
