defmodule PhiaDemoWeb.Demo.FileManager.Layout do
  @moduledoc "File manager app shell layout."
  ...
  def layout(assigns) do
    ...
    <.shell>
      <:topbar>
        ...
        <.project_topbar current_project={:files} dark_mode_id="files-dm" />
      </:topbar>
      <:sidebar>
        <.sidebar>
          <:brand>
            <div class="flex items-center gap-2.5">
              ...
              <div>
                <span class="text-sm font-bold text-foreground leading-none">Files</span>
                <p class="text-[10px] text-muted-foreground leading-none mt-0.5 font-medium">File Manager</p>
              </div>
            </div>
          </:brand>
          <:nav_items>
            <.nav_section label="Storage">
              <.nav_item current_path={@current_path} href="/files" icon="home" label="My Files" />
              <.nav_item current_path={@current_path} href="/files" icon="upload" label="Uploads" />
              <.nav_item current_path={@current_path} href="/files" icon="star" label="Starred" />
              <.nav_item current_path={@current_path} href="/files" icon="trash-2" label="Trash" />
            </.nav_section>
            <.nav_section label="Folders">
              <.nav_item current_path={@current_path} href="/files" icon="folder" label="Documents" />
              <.nav_item current_path={@current_path} href="/files" icon="folder" label="Images" />
              <.nav_item current_path={@current_path} href="/files" icon="folder" label="Projects" />
            </.nav_section>
          </:nav_items>
          <:footer_items>
            <div class="px-3 py-1">
